...
import Component1 from "../../../components/Oursolutioncomponets/Uiuxdesign/Websitedesign/Component1";
...
import UIUX from "../../../public/Solutionasset/Websitedesign.gif";
import Image from "next/image";
import Technologiesused from "@/components/Oursolutioncomponets/Uiuxdesign/Mobileappdesign/Component3";
import Websiteservice from "@/components/Oursolutioncomponets/Uiuxdesign/Websitedesign/Component2";
      ...
      <div className="w-full flex-col flex justify-center items-center mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 place-content-center justify-between md:gap-16 lg:gap-16 gap-4 items-center w-11/12 mx-auto  ">
          <div className="w-full flex flex-col justify-center items-start gap-4 order-2 lg:order-1 md:order-1">
            <div>
              <p className="text-justify text-sm font-medium leading-7">{`At AWT, we specialize in creating standout websites. With our comprehensive design services, we help businesses achieve their online goals effectively.`}</p>
            </div>
            <div>
