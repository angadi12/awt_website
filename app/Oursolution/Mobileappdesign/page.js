...
import Component1 from "../../../components/Oursolutioncomponets/Uiuxdesign/Mobileappdesign/Component1";
...
import UIUX from "../../../public/Solutionasset/Mobileappdesign.gif";
import Image from "next/image";
import Servicecomponet from "@/components/Oursolutioncomponets/Uiuxdesign/Mobileappdesign/Component2";
    ...
    <section className="w-full flex-col  md:mt-14 lg:mt-14 mt-4 ">
      <div className="w-full flex-col flex justify-center items-center mx-auto ">
        <div className="w-11/12 mx-auto">
          <h6 className="md:text-3xl lg:text-3xl text-2xl font-bold capitalize">Mobile app Design</h6>
        </div>
