    ...
    return (
      <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">privacy policy</h6>
...
`}
  ...
  const Cookies = () => {
    return (
        <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">consent</h6>
...
`}</p>
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          ...
          <div className="flex flex-col justify-center items-start gap-2">
            <h6 className="text-sm font-bold uppercase">{`We use the information we collect in various ways, including to:`}</h6>
  ...
  const Iframe = () => {
    return (
        <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">log files</h6>
  ...
  const ContentLiability = () => {
    return (
        <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">cookies & web beacons</h6>
...
`}</p>
  ...
  const Removallinks = () => {
    return (
        <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">{`ccpa privacy rights (do not sell my personal information)`}</h6>
...
contact us.`}</p>
  ...
  const Gdpr = () => {
    return (
        <section className="flex justify-start items-start md:py-12 md:px-12 lg:py-12 lg:px-12 px-2 py-2">
        <div className="flex flex-col justify-center items-start md:gap-8 gap-4 lg:gap-8">
          <h6 className="text-lg font-bold uppercase">{`Children’s Information`}</h6>
