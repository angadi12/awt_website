...
import Component1 from "./Marketing/Component1";
import Component2 from "./Marketing/Component2";
import Component3 from "./Marketing/Component3";
...
import Component8 from "./Marketing/Component8";

const Marketing = () => {
  return (
    <section className="w-full flex-col gap-8 -mt-12 md:mt-0 lg:mt-0">
    <div className="w-11/12 mx-auto">
      <h1 className="md:text-3xl text-2xl lg:text-3xl font-semibold capitalize tracking-wider">
        Tailored{" "}
